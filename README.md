...
- **Stromskosten** in Euro (netto brutto, je nachdem, ob die Mehrwersteuer-Checkbox aktiv oder inaktiv ist)
...
## Aufteilung
- **Library (`energieverbrauchsrechenr`)**
...
Zum Starten des Programms wird ein Skript im Verzeichnis deploy/ angelegt, das die nötigen Laufzeitpfade setzt:
